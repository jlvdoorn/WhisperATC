...
training_args = Seq2SeqTrainingArguments(
    ...
    gradient_accumulation_steps=1, # x 4 (num of gpus)
    learning_rate=1e-5,
    warmup_steps=250,
    max_steps=12500,
...
kwargs = {
    ...
    "dataset": "ATCOSIM",  # a 'pretty' name for the training dataset
    "dataset_args": "config: en, split: train",
    "language": "en",
    "model_name": "Whisper Large v2 - ATCOSIM",  # a 'pretty' name for your model
    "finetuned_from": mdl,
